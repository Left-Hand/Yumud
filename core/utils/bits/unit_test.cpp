...
namespace BitOperationTests {
    ...
    // 测试 size
    static_assert(BitsSet<1>::size() == 1);
    static_assert(BitsSet<8>::size() == 8);
    static_assert(BitsSet<16>::size() == 16);
    static_assert(BitsSet<32>::size() == 32);
} // namespace BitOperationTests
...
namespace ConnectionTests {
    ...
    static_assert(connected.size() == 8);
    ...
    static_assert(connected2.size() == 12);
    ...
    static_assert(connected3.size() == 5);
} // namespace ConnectionTests
...
namespace SplitTests {
    ...
    static_assert(std::get<0>(split_result1).size() == 4);
    static_assert(std::get<1>(split_result1).size() == 4);
    ...
    static_assert(std::get<0>(split_result2).size() == 2);
    static_assert(std::get<1>(split_result2).size() == 6);
    ...
    static_assert(std::get<0>(split_result3).size() == 6);
    static_assert(std::get<1>(split_result3).size() == 2);
