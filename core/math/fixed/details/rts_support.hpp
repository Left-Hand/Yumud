...
[[nodiscard]] __attribute__((__always_inline__)) constexpr 
int32_t __mpyx_w(int16_t arg1, int16_t arg2){
    return (int32_t(arg1) * int32_t(arg2));
}

[[nodiscard]] __attribute__((__always_inline__)) constexpr 
uint32_t __mpyx_uw(uint16_t arg1, uint16_t arg2){
    return (uint32_t(arg1) * uint32_t(arg2));
}

[[nodiscard]] __attribute__((__always_inline__)) constexpr 
int16_t __mpyf_w(int16_t arg1, int16_t arg2){
    return int16_t((int32_t(arg1) * int32_t(arg2)) >> 15);
}

[[nodiscard]] __attribute__((__always_inline__)) constexpr 
int16_t __mpyf_w_reuse_arg1(int16_t arg1, int16_t arg2){
    /* This is identical to __mpyf_w */
    return int16_t((int32_t(arg1) * int32_t(arg2)) >> 15);
}

[[nodiscard]] __attribute__((__always_inline__)) constexpr 
uint16_t __mpyf_uw(uint16_t arg1, uint16_t arg2){
    return uint16_t((uint32_t(arg1) * uint32_t(arg2)) >> 15);
}

[[nodiscard]] __attribute__((__always_inline__)) constexpr 
uint16_t __mpyf_uw_reuse_arg1(uint16_t arg1, uint16_t arg2){
    /* This is identical to __mpyf_uw */
    return uint16_t((uint32_t(arg1) * uint32_t(arg2)) >> 15);
}

[[nodiscard]] __attribute__((__always_inline__)) constexpr 
int32_t __mpyfx_w(int16_t arg1, int16_t arg2){
    return ((int32_t(arg1) * int32_t(arg2)) << 1);
}

[[nodiscard]] __attribute__((__always_inline__)) constexpr 
int32_t __mpyfx_uw(uint16_t arg1, uint16_t arg2){
...
[[nodiscard]] __attribute__((__always_inline__)) constexpr 
int64_t __mpyx(int32_t arg1, int32_t arg2){
...
[[nodiscard]] __attribute__((__always_inline__)) constexpr 
int32_t __mpyf_l_reuse_arg1(int32_t arg1, int32_t arg2){
