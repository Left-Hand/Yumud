...
using iq4 = math::fixed<4, int32_t>;
using iq5 = math::fixed<5, int32_t>;
using iq6 = math::fixed<6, int32_t>;
using iq7 = math::fixed<7, int32_t>;
using iq8 = math::fixed<8, int32_t>;
using iq9 = math::fixed<9, int32_t>;

using iq10 = math::fixed<10, int32_t>;
using iq11 = math::fixed<11, int32_t>;
using iq12 = math::fixed<12, int32_t>;
using iq13 = math::fixed<13, int32_t>;
using iq14 = math::fixed<14, int32_t>;
using iq15 = math::fixed<15, int32_t>;
using iq16 = math::fixed<16, int32_t>;
using iq17 = math::fixed<17, int32_t>;
using iq18 = math::fixed<18, int32_t>;
using iq19 = math::fixed<19, int32_t>;

using iq20 = math::fixed<20, int32_t>;
using iq21 = math::fixed<21, int32_t>;
using iq22 = math::fixed<22, int32_t>;
using iq23 = math::fixed<23, int32_t>;
using iq24 = math::fixed<24, int32_t>;
using iq25 = math::fixed<25, int32_t>;
using iq26 = math::fixed<26, int32_t>;
using iq27 = math::fixed<27, int32_t>;
using iq28 = math::fixed<28, int32_t>;
using iq29 = math::fixed<29, int32_t>;

using iq30 = math::fixed<30, int32_t>;
using iq31 = math::fixed<31, int32_t>;

//允许iq0.32的存在 它的值域为[-0.5, 0.5)
using iq32 = math::fixed<32, int32_t>;

using iiq1 = math::fixed<1, int64_t>;
using iiq2 = math::fixed<2, int64_t>;
using iiq3 = math::fixed<3, int64_t>;
using iiq4 = math::fixed<4, int64_t>;
using iiq5 = math::fixed<5, int64_t>;
using iiq6 = math::fixed<6, int64_t>;
using iiq7 = math::fixed<7, int64_t>;
using iiq8 = math::fixed<8, int64_t>;
using iiq9 = math::fixed<9, int64_t>;

using iiq10 = math::fixed<10, int64_t>;
using iiq11 = math::fixed<11, int64_t>;
using iiq12 = math::fixed<12, int64_t>;
using iiq13 = math::fixed<13, int64_t>;
using iiq14 = math::fixed<14, int64_t>;
using iiq15 = math::fixed<15, int64_t>;
using iiq16 = math::fixed<16, int64_t>;
using iiq17 = math::fixed<17, int64_t>;
using iiq18 = math::fixed<18, int64_t>;
using iiq19 = math::fixed<19, int64_t>;

using iiq20 = math::fixed<20, int64_t>;
using iiq21 = math::fixed<21, int64_t>;
using iiq22 = math::fixed<22, int64_t>;
using iiq23 = math::fixed<23, int64_t>;
using iiq24 = math::fixed<24, int64_t>;
using iiq25 = math::fixed<25, int64_t>;
using iiq26 = math::fixed<26, int64_t>;
using iiq27 = math::fixed<27, int64_t>;
using iiq28 = math::fixed<28, int64_t>;
using iiq29 = math::fixed<29, int64_t>;

using iiq30 = math::fixed<30, int64_t>;
using iiq31 = math::fixed<31, int64_t>;
using iiq32 = math::fixed<32, int64_t>;
using iiq33 = math::fixed<33, int64_t>;
using iiq34 = math::fixed<34, int64_t>;
using iiq35 = math::fixed<35, int64_t>;
using iiq36 = math::fixed<36, int64_t>;
using iiq37 = math::fixed<37, int64_t>;
using iiq38 = math::fixed<38, int64_t>;
using iiq39 = math::fixed<39, int64_t>;

using iiq40 = math::fixed<40, int64_t>;
using iiq41 = math::fixed<41, int64_t>;
using iiq42 = math::fixed<42, int64_t>;
using iiq43 = math::fixed<43, int64_t>;
using iiq44 = math::fixed<44, int64_t>;
using iiq45 = math::fixed<45, int64_t>;
using iiq46 = math::fixed<46, int64_t>;
using iiq47 = math::fixed<47, int64_t>;
using iiq48 = math::fixed<48, int64_t>;
using iiq49 = math::fixed<49, int64_t>;

using iiq50 = math::fixed<50, int64_t>;
using iiq51 = math::fixed<51, int64_t>;
using iiq52 = math::fixed<52, int64_t>;
using iiq53 = math::fixed<53, int64_t>;
using iiq54 = math::fixed<54, int64_t>;
using iiq55 = math::fixed<55, int64_t>;
using iiq56 = math::fixed<56, int64_t>;
using iiq57 = math::fixed<57, int64_t>;
using iiq58 = math::fixed<58, int64_t>;
using iiq59 = math::fixed<59, int64_t>;

using iiq60 = math::fixed<60, int64_t>;
using iiq61 = math::fixed<61, int64_t>;
using iiq62 = math::fixed<62, int64_t>;
using iiq63 = math::fixed<63, int64_t>;

using uq1 = math::fixed<1, uint32_t>;
using uq2 = math::fixed<2, uint32_t>;
using uq3 = math::fixed<3, uint32_t>;
using uq4 = math::fixed<4, uint32_t>;
using uq5 = math::fixed<5, uint32_t>;
using uq6 = math::fixed<6, uint32_t>;
using uq7 = math::fixed<7, uint32_t>;
using uq8 = math::fixed<8, uint32_t>;
using uq9 = math::fixed<9, uint32_t>;

using uq10 = math::fixed<10, uint32_t>;
using uq11 = math::fixed<11, uint32_t>;
using uq12 = math::fixed<12, uint32_t>;
using uq13 = math::fixed<13, uint32_t>;
using uq14 = math::fixed<14, uint32_t>;
using uq15 = math::fixed<15, uint32_t>;
using uq16 = math::fixed<16, uint32_t>;
using uq17 = math::fixed<17, uint32_t>;
using uq18 = math::fixed<18, uint32_t>;
using uq19 = math::fixed<19, uint32_t>;

using uq20 = math::fixed<20, uint32_t>;
using uq21 = math::fixed<21, uint32_t>;
using uq22 = math::fixed<22, uint32_t>;
using uq23 = math::fixed<23, uint32_t>;
using uq24 = math::fixed<24, uint32_t>;
using uq25 = math::fixed<25, uint32_t>;
using uq26 = math::fixed<26, uint32_t>;
using uq27 = math::fixed<27, uint32_t>;
using uq28 = math::fixed<28, uint32_t>;
using uq29 = math::fixed<29, uint32_t>;
using uq30 = math::fixed<30, uint32_t>;
using uq31 = math::fixed<31, uint32_t>;
using uq32 = math::fixed<32, uint32_t>;

using uuq1 = math::fixed<1, uint64_t>;
using uuq2 = math::fixed<2, uint64_t>;
using uuq3 = math::fixed<3, uint64_t>;
using uuq4 = math::fixed<4, uint64_t>;
using uuq5 = math::fixed<5, uint64_t>;
using uuq6 = math::fixed<6, uint64_t>;
using uuq7 = math::fixed<7, uint64_t>;
using uuq8 = math::fixed<8, uint64_t>;
using uuq9 = math::fixed<9, uint64_t>;

using uuq10 = math::fixed<10, uint64_t>;
using uuq11 = math::fixed<11, uint64_t>;
using uuq12 = math::fixed<12, uint64_t>;
using uuq13 = math::fixed<13, uint64_t>;
using uuq14 = math::fixed<14, uint64_t>;
using uuq15 = math::fixed<15, uint64_t>;
using uuq16 = math::fixed<16, uint64_t>;
using uuq17 = math::fixed<17, uint64_t>;
using uuq18 = math::fixed<18, uint64_t>;
using uuq19 = math::fixed<19, uint64_t>;

using uuq20 = math::fixed<20, uint64_t>;
using uuq21 = math::fixed<21, uint64_t>;
using uuq22 = math::fixed<22, uint64_t>;
using uuq23 = math::fixed<23, uint64_t>;
using uuq24 = math::fixed<24, uint64_t>;
using uuq25 = math::fixed<25, uint64_t>;
using uuq26 = math::fixed<26, uint64_t>;
using uuq27 = math::fixed<27, uint64_t>;
using uuq28 = math::fixed<28, uint64_t>;
using uuq29 = math::fixed<29, uint64_t>;

using uuq30 = math::fixed<30, uint64_t>;
using uuq31 = math::fixed<31, uint64_t>;
using uuq32 = math::fixed<32, uint64_t>;
using uuq33 = math::fixed<33, uint64_t>;
using uuq34 = math::fixed<34, uint64_t>;
using uuq35 = math::fixed<35, uint64_t>;
using uuq36 = math::fixed<36, uint64_t>;
using uuq37 = math::fixed<37, uint64_t>;
using uuq38 = math::fixed<38, uint64_t>;
using uuq39 = math::fixed<39, uint64_t>;

using uuq40 = math::fixed<40, uint64_t>;
using uuq41 = math::fixed<41, uint64_t>;
using uuq42 = math::fixed<42, uint64_t>;
using uuq43 = math::fixed<43, uint64_t>;
using uuq44 = math::fixed<44, uint64_t>;
using uuq45 = math::fixed<45, uint64_t>;
using uuq46 = math::fixed<46, uint64_t>;
using uuq47 = math::fixed<47, uint64_t>;
using uuq48 = math::fixed<48, uint64_t>;
using uuq49 = math::fixed<49, uint64_t>;

using uuq50 = math::fixed<50, uint64_t>;
using uuq51 = math::fixed<51, uint64_t>;
using uuq52 = math::fixed<52, uint64_t>;
using uuq53 = math::fixed<53, uint64_t>;
using uuq54 = math::fixed<54, uint64_t>;
using uuq55 = math::fixed<55, uint64_t>;
using uuq56 = math::fixed<56, uint64_t>;
using uuq57 = math::fixed<57, uint64_t>;
using uuq58 = math::fixed<58, uint64_t>;
using uuq59 = math::fixed<59, uint64_t>;
using uuq60 = math::fixed<60, uint64_t>;

using uuq61 = math::fixed<61, uint64_t>;
