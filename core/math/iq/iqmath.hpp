...
template<size_t Q>
__fast_inline constexpr fixed_t<31, int32_t> sin(const fixed_t<Q, int32_t> x){return sinf<Q>(x);}

template<size_t Q>
__fast_inline constexpr fixed_t<31, int32_t> cos(const fixed_t<Q, int32_t> x){return cosf<Q>(x);}

template<size_t Q>
__fast_inline constexpr fixed_t<31, int32_t> tanf(const fixed_t<Q, int32_t> x) {return sinf<Q>(x) / cosf<Q>(x);}

template<size_t Q>
__fast_inline constexpr fixed_t<31, int32_t> tan(const fixed_t<Q, int32_t> x) {return tanf<Q>(x);}
