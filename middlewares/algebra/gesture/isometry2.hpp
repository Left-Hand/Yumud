...
#include "middlewares/algebra/vectors/unit_complex.hpp"
...
struct [[nodiscard]] Isometry2 { 
    ...
    friend OutputStream & operator << (OutputStream & os, const Isometry2<T> & self) { 
        return os << os.field("rotation")(self.rotation) << os.splitter()
            << os.field("translation")(self.translation);
    }
