...
[[maybe_unused]] static void test_ser0x01(){

    {
        ...
        static_assert(srz.bytes[11] == 0x08);
    }
}
...
[[maybe_unused]] static void test_ser0x03(){
    ...
    
    {
        ...
        static_assert(srz.bytes[3] == 0x00);  // 起始地址低字节
        static_assert(srz.bytes[4] == 0x00);  // 寄存器数量高字节
        static_assert(srz.bytes[5] == 0x02);  // 寄存器数量低字节
        static_assert(srz.bytes[6] == 0xC4);  // CRC 低字节
        static_assert(srz.bytes[7] == 0x0B);  // CRC 高字节
    }

    {
        ...
        static_assert(srz.bytes[1] == 0x03);
        static_assert(srz.bytes[2] == 0x00);
        static_assert(srz.bytes[3] == 0x64);  // 100 = 0x64
        static_assert(srz.bytes[4] == 0x00);
...

    {
        ...
        static_assert(srz.bytes[5]  == 0x06);  // 长度低字节 (1+1+2+2=6)
        static_assert(srz.bytes[6]  == 0x01);  // 单元ID
        static_assert(srz.bytes[7]  == 0x03);  // 功能码
        static_assert(srz.bytes[8]  == 0x00);  // 起始地址高字节
        static_assert(srz.bytes[9]  == 0x00);  // 起始地址低字节
        static_assert(srz.bytes[10] == 0x00);  // 寄存器数量高字节
        static_assert(srz.bytes[11] == 0x02);  // 寄存器数量低字节
    }

    {
        ...
        static_assert(srz.bytes[5] == 0x06);
        static_assert(srz.bytes[6] == 0x01);
        static_assert(srz.bytes[7] == 0x03);
        static_assert(srz.bytes[8] == 0x00);
        static_assert(srz.bytes[9] == 0x00);
        static_assert(srz.bytes[10] == 0x00);
        static_assert(srz.bytes[11] == 0x02);
    }

    {
        ...
        static_assert(srz.length() == 12);
        static_assert(srz.bytes[0]  == 0x00);
        static_assert(srz.bytes[1]  == 0x00);
        static_assert(srz.bytes[2]  == 0x00);
        static_assert(srz.bytes[3]  == 0x00);
        static_assert(srz.bytes[4]  == 0x00);
        static_assert(srz.bytes[5]  == 0x06);
        ...
        static_assert(srz.bytes[7]  == 0x03);
        static_assert(srz.bytes[8]  == 0x00);
        static_assert(srz.bytes[9]  == 0x64);  // 100 = 0x64
        static_assert(srz.bytes[10] == 0x00);
...
[[maybe_unused]] static void test_ser0x10(){
    {
        ...
        static_assert(srz.bytes[4] == 0x00);  // 寄存器数量高字节
        static_assert(srz.bytes[5] == 0x02);  // 寄存器数量低字节
        static_assert(srz.bytes[6] == 0x04);  // 字节数 (2寄存器 × 2字节)
        static_assert(srz.bytes[7] == 0x00);  // 数据1高字节
        static_assert(srz.bytes[8] == 0x01);  // 数据1低字节
        static_assert(srz.bytes[9] == 0x12);  // 数据2高字节
        static_assert(srz.bytes[10] == 0x34); // 数据2低字节
...

    {
        ...
        static_assert(srz.length() == 17);
        static_assert(srz.bytes[0]  == 0x02);  // 事务ID高字节
        static_assert(srz.bytes[1]  == 0x68);  // 事务ID低字节
        static_assert(srz.bytes[2]  == 0x00);
        static_assert(srz.bytes[3]  == 0x00);
        static_assert(srz.bytes[4]  == 0x00);
        static_assert(srz.bytes[5]  == 0x0B);  // 长度 (1+1+2+2+1+4=11)
        static_assert(srz.bytes[6]  == 0x01);
        static_assert(srz.bytes[7]  == 0x10);  // 功能码 0x10
        static_assert(srz.bytes[8]  == 0x00);
        static_assert(srz.bytes[9]  == 0x00);  // 起始地址
        static_assert(srz.bytes[10] == 0x00);
        static_assert(srz.bytes[11] == 0x02);  // 寄存器数量
        static_assert(srz.bytes[12] == 0x04);  // 字节数
        static_assert(srz.bytes[13] == 0x00);
        static_assert(srz.bytes[14] == 0x01);  // 值1
        static_assert(srz.bytes[15] == 0x12);
        static_assert(srz.bytes[16] == 0x34);  // 值2
    }
}
...
[[maybe_unused]] static void test_ser0x11(){
...

    {
        ...
        static_assert(srz.bytes[3] == 0x00);
        static_assert(srz.bytes[4] == 0x00);
        static_assert(srz.bytes[5] == 0x02);  // 长度 (1+1=2)
...
[[maybe_unused]] static void test_ser0x16(){
...

    {
        ...
        static_assert(srz.bytes[3]  == 0x00);
        static_assert(srz.bytes[4]  == 0x00);
        static_assert(srz.bytes[5]  == 0x08);  // 长度
...
[[maybe_unused]] static void test_ser0x29(){
    {
        ...
        // 预期: 08 29 CRC
        static_assert(srz.length() == 4);
        static_assert(srz.bytes[0] == 0x08);  // 设备地址
        static_assert(srz.bytes[1] == 0x29);  // 功能码 0x29
    }

    {
        ...
        static_assert(srz.length() == 8);
        static_assert(srz.bytes[0] == 0x56);
        static_assert(srz.bytes[1] == 0x78);  // 事务ID
        static_assert(srz.bytes[2] == 0x00);
        static_assert(srz.bytes[3] == 0x00);
        static_assert(srz.bytes[4] == 0x00);
        static_assert(srz.bytes[5] == 0x02);  // 长度
        static_assert(srz.bytes[6] == 0x03);  // 单元标识符
        static_assert(srz.bytes[7] == 0x29);  // 功能码
    }
}
