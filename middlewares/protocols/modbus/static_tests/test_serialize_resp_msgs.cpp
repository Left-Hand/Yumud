...
[[maybe_unused]] static void test_ser_resp_0x01(){

    {
        ...
        static_assert(serializer.bytes[5]  == 0x04);  // 长度 (1+1+1+1=4)
        static_assert(serializer.bytes[6]  == 0x01);
        static_assert(serializer.bytes[7]  == 0x01);  // 功能码 0x01
        static_assert(serializer.bytes[8]  == 0x01);  // 字节计数
        static_assert(serializer.bytes[9]  == 0xFF);  // 线圈状态
    }

    {
        ...
        static_assert(serializer.bytes[1] == 0x01);  // 功能码
        static_assert(serializer.bytes[2] == 0x01);  // 字节计数
        static_assert(serializer.bytes[3] == 0x03);  // 线圈状态
    }
}
...
[[maybe_unused]] static void test_ser_resp_0x02(){
    ...
    
    {
        ...
        static_assert(serializer.length() == 10);
        static_assert(serializer.bytes[0]  == 0x00);
        static_assert(serializer.bytes[1]  == 0x12);  // 事务ID
        static_assert(serializer.bytes[2]  == 0x00);
        static_assert(serializer.bytes[3]  == 0x00);
        static_assert(serializer.bytes[4]  == 0x00);
        static_assert(serializer.bytes[5]  == 0x04);  // 长度
        static_assert(serializer.bytes[6]  == 0x01);
        static_assert(serializer.bytes[7]  == 0x02);  // 功能码 0x02
        static_assert(serializer.bytes[8]  == 0x01);  // 字节计数
        static_assert(serializer.bytes[9]  == 0x0F);  // 离散输入状态
    }

    {
        ...
        static_assert(serializer.length() == 6);
        static_assert(serializer.bytes[0] == 0x01);  // 设备地址
        static_assert(serializer.bytes[1] == 0x02);  // 功能码
        static_assert(serializer.bytes[2] == 0x01);  // 字节计数
        static_assert(serializer.bytes[3] == 0xAA);  // 离散输入状态
    }
}
...
[[maybe_unused]] static void test_ser_resp_0x03(){
    ...
    
    {
        ...
        static_assert(serializer.bytes[2] == 0x04);  // 字节计数 (2*2=4)
        static_assert(serializer.bytes[3] == 0x00);  // 寄存器1高字节
        static_assert(serializer.bytes[4] == 0x0A);  // 寄存器1低字节
        static_assert(serializer.bytes[5] == 0x01);  // 寄存器2高字节
        static_assert(serializer.bytes[6] == 0x02);  // 寄存器2低字节
    }

    {
        ...
        static_assert(serializer.bytes[5]  == 0x07);  // 长度低字节 (1+1+1+4=7)
        static_assert(serializer.bytes[6]  == 0x01);  // 单元ID
        static_assert(serializer.bytes[7]  == 0x03);  // 功能码
        static_assert(serializer.bytes[8]  == 0x04);  // 字节计数
        static_assert(serializer.bytes[9]  == 0x00);  // 寄存器1高字节
        static_assert(serializer.bytes[10] == 0x0A);  // 寄存器1低字节
        static_assert(serializer.bytes[11] == 0x01);  // 寄存器2高字节
        static_assert(serializer.bytes[12] == 0x02);  // 寄存器2低字节
    }

    {
        ...
        static_assert(serializer.bytes[3] == 0x00);
        static_assert(serializer.bytes[4] == 0x00);
        static_assert(serializer.bytes[5] == 0x05);  // 长度 (1+1+1+2=5)
        static_assert(serializer.bytes[6] == 0x01);
        static_assert(serializer.bytes[7] == 0x03);  // 功能码
        static_assert(serializer.bytes[8] == 0x02);  // 字节计数 (1*2=2)
        static_assert(serializer.bytes[9] == 0x00);  // 寄存器值高字节
        static_assert(serializer.bytes[10] == 0xFF); // 寄存器值低字节
    }
}
...
[[maybe_unused]] static void test_ser_resp_0x04(){
    ...
    
    {
        ...
        static_assert(serializer.bytes[3]  == 0x00);
        static_assert(serializer.bytes[4]  == 0x00);
        static_assert(serializer.bytes[5]  == 0x07);  // 长度 (1+1+1+4=7)
        static_assert(serializer.bytes[6]  == 0x01);
        static_assert(serializer.bytes[7]  == 0x04);  // 功能码 0x04
        static_assert(serializer.bytes[8]  == 0x04);  // 字节计数
        static_assert(serializer.bytes[9]  == 0x00);
        static_assert(serializer.bytes[10] == 0x0A);
        static_assert(serializer.bytes[11] == 0x01);
        static_assert(serializer.bytes[12] == 0x02);
    }

    {
        ...
        static_assert(serializer.length() == 7);
        static_assert(serializer.bytes[0] == 0x01);  // 设备地址
        static_assert(serializer.bytes[1] == 0x04);  // 功能码
        static_assert(serializer.bytes[2] == 0x02);  // 字节计数 (1*2=2)
        static_assert(serializer.bytes[3] == 0x05);  // 寄存器值高字节
        static_assert(serializer.bytes[4] == 0xDC);  // 寄存器值低字节
    }
}
...
[[maybe_unused]] static void test_ser_resp_0x05(){
...

    {
        ...
        static_assert(serializer.bytes[3]  == 0x00);
        static_assert(serializer.bytes[4]  == 0x00);
        static_assert(serializer.bytes[5]  == 0x06);  // 长度 (1+1+2+2=6)
        static_assert(serializer.bytes[6]  == 0x01);
...

    {
        ...
        static_assert(serializer.bytes[0] == 0x01);  // 设备地址
        static_assert(serializer.bytes[1] == 0x05);  // 功能码
        static_assert(serializer.bytes[2] == 0x00);  // 地址高字节
        static_assert(serializer.bytes[3] == 0x0A);  // 地址低字节
        static_assert(serializer.bytes[4] == 0xFF);  // 值高字节
        static_assert(serializer.bytes[5] == 0x00);  // 值低字节
    }
}
...
[[maybe_unused]] static void test_ser_resp_0x0f(){
...

    {
        ...
        static_assert(serializer.length() == 8);
        static_assert(serializer.bytes[0] == 0x01);  // 设备地址
        static_assert(serializer.bytes[1] == 0x0F);  // 功能码 0x0F
        static_assert(serializer.bytes[2] == 0x00);  // 起始地址高字节
        static_assert(serializer.bytes[3] == 0x04);  // 起始地址低字节
        static_assert(serializer.bytes[4] == 0x00);  // 数量高字节
        static_assert(serializer.bytes[5] == 0x0A);  // 数量低字节
    }

    {
        ...
        static_assert(serializer.bytes[1]  == 0x69);  // 事务ID低字节
        static_assert(serializer.bytes[2]  == 0x00);
        static_assert(serializer.bytes[3]  == 0x00);
        static_assert(serializer.bytes[4]  == 0x00);
        static_assert(serializer.bytes[5]  == 0x06);  // 长度 (1+1+2+2=6)
        static_assert(serializer.bytes[6]  == 0x01);
        static_assert(serializer.bytes[7]  == 0x0F);  // 功能码 0x0F
        static_assert(serializer.bytes[8]  == 0x00);
        static_assert(serializer.bytes[9]  == 0x00);  // 起始地址
        static_assert(serializer.bytes[10] == 0x00);
        static_assert(serializer.bytes[11] == 0x08);  // 数量
    }
}
...
[[maybe_unused]] static void test_ser_resp_0x10(){
...

    {
        ...
        static_assert(serializer.bytes[3] == 0x04);  // 起始地址低字节
        static_assert(serializer.bytes[4] == 0x00);  // 数量高字节
        static_assert(serializer.bytes[5] == 0x02);  // 数量低字节
    }

    {
        ...
        static_assert(serializer.bytes[9]  == 0x00);  // 起始地址
        static_assert(serializer.bytes[10] == 0x00);
        static_assert(serializer.bytes[11] == 0x02);  // 数量
    }
}
...
[[maybe_unused]] static void test_ser_resp_0x16(){
...

    {
        ...
        static_assert(serializer.bytes[3]  == 0x00);
        static_assert(serializer.bytes[4]  == 0x00);
        static_assert(serializer.bytes[5]  == 0x08);  // 长度 (1+1+2+2+2=8)
...
[[maybe_unused]] static void test_ser_resp_0x17(){
...

    {
        ...
        static_assert(serializer.length() == 9);
        static_assert(serializer.bytes[0] == 0x01);  // 设备地址
        static_assert(serializer.bytes[1] == 0x17);  // 功能码 0x17
        static_assert(serializer.bytes[2] == 0x04);  // 字节计数 (2*2=4)
        static_assert(serializer.bytes[3] == 0x00);  // 寄存器1高字节
        static_assert(serializer.bytes[4] == 0x01);  // 寄存器1低字节
        static_assert(serializer.bytes[5] == 0x12);  // 寄存器2高字节
        static_assert(serializer.bytes[6] == 0x34);  // 寄存器2低字节
    }

    {
        ...
        static_assert(serializer.length() == 15);
        static_assert(serializer.bytes[0]  == 0x02);  // 事务ID高字节
        static_assert(serializer.bytes[1]  == 0x6A);  // 事务ID低字节
        static_assert(serializer.bytes[2]  == 0x00);
        static_assert(serializer.bytes[3]  == 0x00);
        static_assert(serializer.bytes[4]  == 0x00);
        static_assert(serializer.bytes[5]  == 0x09);  // 长度 (1+1+1+6=9)
        static_assert(serializer.bytes[6]  == 0x01);
        static_assert(serializer.bytes[7]  == 0x17);  // 功能码 0x17
        static_assert(serializer.bytes[8]  == 0x06);  // 字节计数 (3*2=6)
        static_assert(serializer.bytes[9]  == 0x00);
        static_assert(serializer.bytes[10] == 0x0A);
        static_assert(serializer.bytes[11] == 0x01);
        static_assert(serializer.bytes[12] == 0x02);
        static_assert(serializer.bytes[13] == 0xAB);
        static_assert(serializer.bytes[14] == 0xCD);
    }
}
