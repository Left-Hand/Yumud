...
class TM1668_Error{
    public:
        ...
        constexpr TM1668_Error(const hal::BusError err)
            {
...
namespace ymd::custom{
    template<typename T>
    struct result_converter<T, drivers::TM1668_Error, hal::BusError> {
        scexpr Result<T, drivers::TM1668_Error> convert(const hal::BusError berr){
