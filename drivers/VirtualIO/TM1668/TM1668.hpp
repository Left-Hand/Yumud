...
class TM1668_Error{
    public:
        ...
        constexpr TM1668_Error(const BusError err)
            {
...
namespace ymd::custom{
    template<typename T>
    struct result_converter<T, drivers::TM1668_Error, BusError> {
        scexpr Result<T, drivers::TM1668_Error> convert(const BusError berr){
