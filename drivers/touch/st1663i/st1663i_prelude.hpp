...
struct alignas(4) [[nodiscard]] PackedPoint final{
    ...
    [[nodiscard]] constexpr uint16_t x() const noexcept {
        return (u8_xy0_h.u8X0_H << 5) | u8_x0_l;
    }

    [[nodiscard]] constexpr uint16_t y() const noexcept {
        return (u8_xy0_h.u8Y0_H << 5) | u8_y0_l;
    }

    [[nodiscard]] constexpr uint8_t z() const noexcept {
        return u8_z;
    }

    bool is_valid() const noexcept {
        return u8_xy0_h.is_valid;
    }
