...
public:
    ...
    explicit InvensenseImu_Transport(Some<hal::I2cBase *> i2c, const hal::I2cSlaveAddr<7> i2c_addr):
...
public:
    ...
    [[nodiscard]] Result<void, Error> write_reg(const uint8_t reg_addr, const uint8_t data);
