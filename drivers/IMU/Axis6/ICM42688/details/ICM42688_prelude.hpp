...
struct Regset{
    ...
    struct [[nodiscard]] R16_TMST_FSYNC:public Reg16<>{
        static constexpr RegAddr REG_ADDR = 0x2B;
        int16_t bits;
    ...
    struct [[nodiscard]] R8_APEX_DATA3:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x34;
    ...
    struct [[nodiscard]] R8_APEX_DATA4:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x35;
        uint8_t tap_dir:1;
        uint8_t tap_axis:2;
        uint8_t tap_num:2;
        uint8_t :3;
    ...
    struct [[nodiscard]] R8_INT_STATUS3:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x38;
    ...
    struct [[nodiscard]] R8_WHO_AM_I:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x75;
        static constexpr Bank bank = Bank::_0;
