...
struct Regset final{
    ...
    struct R8_SensorTime:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x18; // SENSOR_TIME_2
    ...
    struct R8_IntStatus0:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x1c; // INT_STATUS_3
        uint8_t step_int:1;
    ...
    struct R8_IntStatus1:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x1d; // INT_STATUS_3
        uint8_t __resv__:2;
        uint8_t highg_int:1;
        uint8_t lowg_int:1;
        uint8_t drdy_int:1;
    ...
    struct R8_IntStatus3:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x1e; // INT_STATUS_3
    ...
    struct R8_GyrConf:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x42;
        GyrOdr gyr_odr:4;
        uint8_t gyr_bwp:2;
    ...
    struct R8_GyrFs:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x43;
        GyrFs gyr_fs:3;
        uint8_t __resv__:5 = 0;
    }DEF_R8(gyr_fs)

    struct R8_MagConf:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x44;
        uint8_t mag_odr:4;
        uint8_t __resv__:4;
    };

    struct R8_FifoDowns:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x45;
    ...
    struct R8_IntEn1:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x51;
    ...
    struct R8_IntEn2:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x52;
    ...
    struct R8_IntMap0:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x55;
    ...
    struct R8_IntMap2:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x57;
    ...
    struct R8_IntData0:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x58;
        uint8_t:3;
    ...
    struct R8_IntData1:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x59;
        uint8_t:7;
        uint8_t int_motion_src:1;
    };

    struct R8_IntLowHigh0:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x5A;
        uint8_t int_low_dur;
    };

    struct R8_IntLowHigh1:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x5B;
        uint8_t int_low_th;
    };

    struct R8_IntLowHigh2:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x5C;
