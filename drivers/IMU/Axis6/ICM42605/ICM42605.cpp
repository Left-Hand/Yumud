...
void ICM42605::init() {
    ...
    writeReg(ICM42605_BANK_SEL, 0);
    writeReg(ICM42605_GYRO_CONFIG0, 0b00000110);
    writeReg(ICM42605_ACCEL_CONFIG0, 0b00000011);
...
//         if (readRegs(ICM42605_ACCEL_DATA_X1, data, 6) == 0)
//             return 1;
...
//         if (readRegs(ICM42605_GYRO_DATA_X1, data, 6) == 0)
//             return 2;
//         out = (int16_t) (data[0] << 8 | data[1]);
...
std::tuple<real_t, real_t, real_t> ICM42605::getAccel(){
    return {0,0,0};//TODO
}

std::tuple<real_t, real_t, real_t> ICM42605::getGyro(){
    return {0,0,0};//TODO
}