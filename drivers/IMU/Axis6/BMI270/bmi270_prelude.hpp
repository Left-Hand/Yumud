...
struct BMI270_Regset:public BMI270_Prelude{
    ...
    struct R8_InternalStatus:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x21;
    ...
    struct R16_FifoLength:public Reg16<>{
        static constexpr RegAddr REG_ADDR = 0x24;
    ...
    struct R8_FifoData:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x26;

        uint8_t :8;
    };

    struct R8_FeatPage:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x2F;
    ...
    struct R8_FifoConfig0:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x48;
        uint8_t fifo_overrun:1;
    };


    struct R8_FifoConfig1:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x49;
    ...
    struct R8_Saturation:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x4A;
    ...
    struct R8_AuxIfTrm:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x68;
    ...
    struct R8_GyrCrtConf:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x69;
    ...
    struct R8_NvmConf:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x6A;
    ...
    struct R8_IfConf:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x6B;
    ...
    struct R8_Dev:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x6c;
    ...
    struct R8_GyeoSelfTest:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x6E;
    ...
    struct R8_NvConf:public Reg8<>{
        static constexpr RegAddr REG_ADDR = 0x70;
    ...
    struct R8_PwrConf{
        static constexpr RegAddr REG_ADDR = 0x7C;
    ...
    struct R8_PweCtrl{
        static constexpr RegAddr REG_ADDR = 0x7D;
        uint8_t aux_en:1;
        uint8_t gyr_en:1;
        uint8_t acc_en:1;
        uint8_t temp_en:1;
