...
struct BMP280_Regs : public BMP280_Prelude {
    ...
    struct ResetReg:public Reg8<>{
        static constexpr RegAddress address=0xE0;
    ...
    struct StatusReg:public Reg8<>{
        static constexpr RegAddress address=0xF3;
        uint8_t im:1;
        uint8_t __resv1__:2;
        uint8_t busy:1;
        uint8_t __resv2__:4;
    ...
    struct CtrlReg:public Reg8<>{
        static constexpr RegAddress address=0xF4;
        uint8_t mode:2;
        uint8_t osrs_p:3;
        uint8_t osrs_t:3;
    };
    ...
    struct ConfigReg:public Reg8<>{
        static constexpr RegAddress address=0xF5;
        uint8_t spi3_en:1;
        uint8_t __resv__:1;
        uint8_t filter:3;
        uint8_t t_sb:3;
    ...
    struct PressureReg:public Reg16<>{
        static constexpr RegAddress address=0xF6;
        uint16_t:16;
    };

    struct PressureXReg:public Reg8<>{
        static constexpr RegAddress address=0xF9;
        uint8_t:8;
    };

    struct TemperatureReg:public Reg16<>{
        static constexpr RegAddress address=0xFA;
        uint16_t:16;
    };

    struct TemperatureXReg:public Reg8<>{
        static constexpr RegAddress address=0xFC;
        uint8_t:8;
    };
