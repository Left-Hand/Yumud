...
struct INA228_Regs:public INA228_Prelude{
    ...
    struct R24_reg_shunt_v:public Reg24<>{ 
        static constexpr RegAddr REG_ADDR = 0x04;  // 24 bit, 312.5 - 78.125 nV / LSB (ADCRANGE)
    ...
    struct R16_reg_bus_v:public Reg16<>{   
        static constexpr RegAddr REG_ADDR = 0x05;  // 24 bit, 195.3125 uV / LSB, 4 low bits == 0
    ...
    struct R16_DieTemp:public Reg16<>{   
        static constexpr RegAddr REG_ADDR = 0x06;  // 16 bit
    ...
    struct R24_Current:public Reg24<>{   
        static constexpr RegAddr REG_ADDR = 0x07;  // 24 bit
    ...
    struct R24_Power:public Reg24<>{   
        static constexpr RegAddr REG_ADDR = 0x08;  // 24 bit
    ...
    struct R64_Energy:public Reg64<>{   
        static constexpr RegAddr REG_ADDR = 0x09;  // 40 bit
    ...
    struct R64_Charge:public Reg64<>{   
        static constexpr RegAddr REG_ADDR = 0x0A;  // 40 bit
    ...
    struct R16_Alert:public Reg16<>{
        static constexpr RegAddr REG_ADDR = 0x0B;  // 16 bit
    ...
    struct R16_SOVL:public Reg16<>{
        static constexpr RegAddr REG_ADDR = 0x0B;  // 16 bit,  shunt overvoltage threshold
    ...
    struct R16_SUVL:public Reg16<>{
        static constexpr RegAddr REG_ADDR = 0x0C;  // 16 bit,  shunt undervoltage threshold
    ...
    struct R16_BOVL:public Reg16<>{
        ...
        static constexpr RegAddr REG_ADDR = 0x0D;  // 16 bit,  bus overvoltage threshold
    ...
    struct R16_BUVL:public Reg16<>{
        static constexpr RegAddr REG_ADDR = 0x0E;  // 16 bit,  bus undervoltage threshold
    ...
    struct R16_TempLimit:public Reg16<>{
        static constexpr RegAddr REG_ADDR = 0x10;  // 16 bit,  temp over
    ...
    struct R16_PowerLimit:public Reg16<>{ 
        ...
        static constexpr RegAddr REG_ADDR = 0x11;  // 16 bit,  power over
    ...
    struct R16_ManfId:public Reg16<>{
        static constexpr RegAddr REG_ADDR = 0x3E;
    ...
    struct R16_DieId:public Reg16<>{  
        static constexpr RegAddr REG_ADDR = 0x3F;
