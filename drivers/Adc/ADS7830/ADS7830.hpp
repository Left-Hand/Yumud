...
struct ADS7830_Prelude{
    ...
    struct ChannelSelection{
        ...
        static constexpr Option<ChannelSelection> from_nth(uint8_t nth){
        ...
        constexpr bool operator == (ChannelSelection const & rhs) const{
    ...
    public:
        ...
        static constexpr Option<PairSelection> 
            from_pos(
