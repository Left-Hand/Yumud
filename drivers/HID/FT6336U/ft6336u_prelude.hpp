...
struct [[nodiscard]] FT6336_Prelude{
public:
    ...
    enum class [[nodiscard]] DeviceMode:uint8_t{
        Working = 0b000,
        Factory = 0b100,
    } ;


    enum class [[nodiscard]] GMode:uint8_t{
        Polling = 0b0,
        Trigger = 0b1,
    } ;


    enum class [[nodiscard]] CtrlMode:uint8_t{
        KeepActive = 0b0,
        ToMonitor = 0b1,
    } ;

    enum class [[nodiscard]] TouchStatus:uint8_t{
        Touch = 0,
        Stream,
        Release,
    } ;
