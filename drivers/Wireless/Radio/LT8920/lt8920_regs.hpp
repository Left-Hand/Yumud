    ...
    struct SyncWordReg:public Reg16{
        scexpr RegAddress head_address = 36;
        uint16_t data;
    };

    struct ThresholdReg:public Reg16{
        scexpr RegAddress address = 40;
    ...
    struct DataRateReg:public Reg16{
        scexpr RegAddress address = 44;
        uint16_t __resv__ :8;
        uint16_t dataRate:8;//透传速率
    };

    struct FlagReg:public Reg16{
        scexpr RegAddress address = 48;
        uint16_t __resv__ :5;
        uint16_t fifoFlag:1;
        uint16_t pktFlag:1;
