...
struct LT8920_Prelude{
    ...
    enum class [[nodiscard]] PacketType:uint8_t{
        NRZLaw = 0,Manchester,Line8_10,Interleave
    };

    enum class [[nodiscard]] TrailerBits:uint8_t{
        _4 = 0,_6,_8,_10,_12,_14,_16,_18
    };

    enum class [[nodiscard]] SyncWordBits:uint8_t{
        _16, _32, _48, _64
    };

    enum class [[nodiscard]] PreambleBits:uint8_t{
        _1 = 0, _2, _3, _4, _5, _6, _7, _8
    };

    enum class [[nodiscard]] BrclkSel:uint8_t{
        Low = 0,Div1, Div2, Div4, Div8,
        Mhz1, Mhz12
    };

    enum class [[nodiscard]] DataRate:uint8_t{
        _1M = 0x01, _250K = 0x04, _125K = 0x08, _62_5K = 0x10
    };
    ...
    enum class [[nodiscard]] Role:uint8_t{
        IDLE,
        BROADCASTER,
        LISTENER
    };
    ...
    static constexpr RegAddr R16_SYNCWORD_BASE_ADDR = 36;
};
