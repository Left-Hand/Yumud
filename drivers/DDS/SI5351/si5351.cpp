...
scexpr auto RFRAC_DENOM 					 = 1000000ULL;
scexpr auto SI5351_XTAL_FREQ                 = 25000000;
scexpr auto SI5351_PLL_FIXED                 = 80000000000ULL;
scexpr auto SI5351_FREQ_MULT                 = 100ULL;
scexpr auto SI5351_DEFAULT_CLK               = 1000000000ULL;
scexpr auto SI5351_PLL_VCO_MIN               = 600000000;
scexpr auto SI5351_PLL_VCO_MAX               = 900000000;
scexpr auto SI5351_MULTISYNTH_MIN_FREQ       = 500000;
scexpr auto SI5351_MULTISYNTH_DIVBY4_FREQ    = 150000000;
scexpr auto SI5351_MULTISYNTH_MAX_FREQ       = 225000000;
scexpr auto SI5351_MULTISYNTH_SHARE_MAX      = 100000000;
scexpr auto SI5351_MULTISYNTH_SHARE_MIN      = 1024000;
scexpr auto SI5351_MULTISYNTH67_MAX_FREQ     = SI5351_MULTISYNTH_DIVBY4_FREQ;
scexpr auto SI5351_CLKOUT_MIN_FREQ           = 4000;
scexpr auto SI5351_CLKOUT_MAX_FREQ           = SI5351_MULTISYNTH_MAX_FREQ;
scexpr auto SI5351_MULTISYNTH67_A_MAX        = 254;
scexpr auto SI5351_CLKOUT67_MS_MIN           = SI5351_PLL_VCO_MIN / SI5351_MULTISYNTH67_A_MAX;
scexpr auto SI5351_CLKOUT67_MIN_FREQ         = SI5351_CLKOUT67_MS_MIN / 128;
scexpr auto SI5351_CLKOUT67_MAX_FREQ         = SI5351_MULTISYNTH67_MAX_FREQ;
scexpr auto SI5351_PLL_A_MIN                 = 15;
scexpr auto SI5351_PLL_A_MAX                 = 90;
scexpr auto SI5351_PLL_C_MAX                 = 1048575;
scexpr auto SI5351_PLL_B_MAX                 = (SI5351_PLL_C_MAX-1);
scexpr auto SI5351_MULTISYNTH_A_MIN          = 6;
scexpr auto SI5351_MULTISYNTH_A_MAX          = 1800;
scexpr auto SI5351_MULTISYNTH_C_MAX          = 1048575;
scexpr auto SI5351_MULTISYNTH_B_MAX          = (SI5351_MULTISYNTH_C_MAX-1);
scexpr auto SI5351_MULTISYNTH_P1_MAX         = ((1<<18)-1);
scexpr auto SI5351_MULTISYNTH_P2_MAX         = ((1<<20)-1);
scexpr auto SI5351_MULTISYNTH_P3_MAX         = ((1<<20)-1);
scexpr auto SI5351_VCXO_PULL_MIN             = 30;
scexpr auto SI5351_VCXO_PULL_MAX             = 240;
scexpr auto SI5351_VCXO_MARGIN               = 103;
scexpr auto SI5351_DEVICE_STATUS             = 0;
scexpr auto SI5351_INTERRUPT_STATUS          = 1;
scexpr auto SI5351_INTERRUPT_MASK            = 2;
scexpr auto SI5351_STATUS_SYS_INIT           = (1<<7);
scexpr auto SI5351_STATUS_LOL_B              = (1<<6);
scexpr auto SI5351_STATUS_LOL_A              = (1<<5);
scexpr auto SI5351_STATUS_LOS                = (1<<4);
scexpr auto SI5351_OUTPUT_ENABLE_CTRL        = 3;
scexpr auto SI5351_OEB_PIN_ENABLE_CTRL       = 9;
scexpr auto SI5351_PLL_INPUT_SOURCE          = 15;
scexpr auto SI5351_CLKIN_DIV_MASK            = (3<<6);
scexpr auto SI5351_CLKIN_DIV_1               = (0<<6);
scexpr auto SI5351_CLKIN_DIV_2               = (1<<6);
scexpr auto SI5351_CLKIN_DIV_4               = (2<<6);
scexpr auto SI5351_CLKIN_DIV_8               = (3<<6);
scexpr auto SI5351_PLLB_SOURCE               = (1<<3);
scexpr auto SI5351_PLLA_SOURCE               = (1<<2);
scexpr auto SI5351_CLK0_CTRL                 = 16;
scexpr auto SI5351_CLK1_CTRL                 = 17;
scexpr auto SI5351_CLK2_CTRL                 = 18;
scexpr auto SI5351_CLK3_CTRL                 = 19;
scexpr auto SI5351_CLK4_CTRL                 = 20;
scexpr auto SI5351_CLK5_CTRL                 = 21;
scexpr auto SI5351_CLK6_CTRL                 = 22;
scexpr auto SI5351_CLK7_CTRL                 = 23;
scexpr auto SI5351_CLK_POWERDOWN             = (1<<7);
scexpr auto SI5351_CLK_INTEGER_MODE          = (1<<6);
scexpr auto SI5351_CLK_PLL_SELECT            = (1<<5);
scexpr auto SI5351_CLK_INVERT                = (1<<4);
scexpr auto SI5351_CLK_INPUT_MASK            = (3<<2);
scexpr auto SI5351_CLK_INPUT_XTAL            = (0<<2);
scexpr auto SI5351_CLK_INPUT_CLKIN           = (1<<2);
scexpr auto SI5351_CLK_INPUT_MULTISYNTH_0_4  = (2<<2);
scexpr auto SI5351_CLK_INPUT_MULTISYNTH_N    = (3<<2);
scexpr auto SI5351_CLK_DRIVE_STRENGTH_MASK   = (3<<0);
scexpr auto SI5351_CLK_DRIVE_STRENGTH_2MA    = (0<<0);
scexpr auto SI5351_CLK_DRIVE_STRENGTH_4MA    = (1<<0);
scexpr auto SI5351_CLK_DRIVE_STRENGTH_6MA    = (2<<0);
scexpr auto SI5351_CLK_DRIVE_STRENGTH_8MA    = (3<<0);
scexpr auto SI5351_CLK3_0_DISABLE_STATE      = 24;
scexpr auto SI5351_CLK7_4_DISABLE_STATE      = 25;
scexpr auto SI5351_CLK_DISABLE_STATE_MASK    = 3;
scexpr auto SI5351_CLK_DISABLE_STATE_LOW     = 0;
scexpr auto SI5351_CLK_DISABLE_STATE_HIGH    = 1;
scexpr auto SI5351_CLK_DISABLE_STATE_FLOAT   = 2;
scexpr auto SI5351_CLK_DISABLE_STATE_NEVER   = 3;
scexpr auto SI5351_PARAMETERS_LENGTH         = 8;
scexpr auto SI5351_PLLA_PARAMETERS           = 26;
scexpr auto SI5351_PLLB_PARAMETERS           = 34;
scexpr auto SI5351_CLK0_PARAMETERS           = 42;
scexpr auto SI5351_CLK1_PARAMETERS           = 50;
scexpr auto SI5351_CLK2_PARAMETERS           = 58;
scexpr auto SI5351_CLK3_PARAMETERS           = 66;
scexpr auto SI5351_CLK4_PARAMETERS           = 74;
scexpr auto SI5351_CLK5_PARAMETERS           = 82;
scexpr auto SI5351_CLK6_PARAMETERS           = 90;
scexpr auto SI5351_CLK7_PARAMETERS           = 91;
scexpr auto SI5351_CLK6_7_OUTPUT_DIVIDER     = 92;
scexpr auto SI5351_OUTPUT_CLK_DIV_MASK       = (7 << 4);
scexpr auto SI5351_OUTPUT_CLK6_DIV_MASK      = (7 << 0);
scexpr auto SI5351_OUTPUT_CLK_DIV_SHIFT      = 4;
scexpr auto SI5351_OUTPUT_CLK_DIV6_SHIFT     = 0;
scexpr auto SI5351_OUTPUT_CLK_DIV_1          = 0;
scexpr auto SI5351_OUTPUT_CLK_DIV_2          = 1;
scexpr auto SI5351_OUTPUT_CLK_DIV_4          = 2;
scexpr auto SI5351_OUTPUT_CLK_DIV_8          = 3;
scexpr auto SI5351_OUTPUT_CLK_DIV_16         = 4;
scexpr auto SI5351_OUTPUT_CLK_DIV_32         = 5;
scexpr auto SI5351_OUTPUT_CLK_DIV_64         = 6;
scexpr auto SI5351_OUTPUT_CLK_DIV_128        = 7;
scexpr auto SI5351_OUTPUT_CLK_DIVBY4       	 = (3<<2);
scexpr auto SI5351_SSC_PARAM0                = 149;
scexpr auto SI5351_SSC_PARAM1                = 150;
scexpr auto SI5351_SSC_PARAM2                = 151;
scexpr auto SI5351_SSC_PARAM3                = 152;
scexpr auto SI5351_SSC_PARAM4                = 153;
scexpr auto SI5351_SSC_PARAM5                = 154;
scexpr auto SI5351_SSC_PARAM6                = 155;
scexpr auto SI5351_SSC_PARAM7                = 156;
scexpr auto SI5351_SSC_PARAM8                = 157;
scexpr auto SI5351_SSC_PARAM9                = 158;
scexpr auto SI5351_SSC_PARAM10               = 159;
scexpr auto SI5351_SSC_PARAM11               = 160;
scexpr auto SI5351_SSC_PARAM12               = 161;
scexpr auto SI5351_VXCO_PARAMETERS_LOW       = 162;
scexpr auto SI5351_VXCO_PARAMETERS_MID       = 163;
scexpr auto SI5351_VXCO_PARAMETERS_HIGH      = 164;
scexpr auto SI5351_CLK0_PHASE_OFFSET         = 165;
scexpr auto SI5351_CLK1_PHASE_OFFSET         = 166;
scexpr auto SI5351_CLK2_PHASE_OFFSET         = 167;
scexpr auto SI5351_CLK3_PHASE_OFFSET         = 168;
scexpr auto SI5351_CLK4_PHASE_OFFSET         = 169;
scexpr auto SI5351_CLK5_PHASE_OFFSET         = 170;
scexpr auto SI5351_PLL_RESET                 = 177;
scexpr auto SI5351_PLL_RESET_B               = (1<<7);
scexpr auto SI5351_PLL_RESET_A               = (1<<5);
scexpr auto SI5351_CRYSTAL_LOAD              = 183;
scexpr auto SI5351_CRYSTAL_LOAD_MASK         = (3<<6);
scexpr auto SI5351_CRYSTAL_LOAD_0PF          = (0<<6);
scexpr auto SI5351_CRYSTAL_LOAD_6PF          = (1<<6);
scexpr auto SI5351_CRYSTAL_LOAD_8PF          = (2<<6);
scexpr auto SI5351_CRYSTAL_LOAD_10PF         = (3<<6);
scexpr auto SI5351_FANOUT_ENABLE             = 187;
scexpr auto SI5351_CLKIN_ENABLE              = (1<<7);
scexpr auto SI5351_XTAL_ENABLE               = (1<<6);
scexpr auto SI5351_MULTISYNTH_ENABLE         = (1<<4);
...
uint8_t Si5351::si5351_write_bulk(uint8_t addr, uint8_t bytes, const uint8_t *data){
	i2c_drv.write_burst(addr, std::span(data, bytes)).unwrap();
    return 0;
}

uint8_t Si5351::si5351_write(uint8_t addr, uint8_t data){
    i2c_drv.write_reg(addr, data).unwrap();
    return 0;
}

uint8_t Si5351::si5351_read(uint8_t addr){
	uint8_t ret;
    i2c_drv.read_reg(addr, ret).unwrap();
	return ret;
}
