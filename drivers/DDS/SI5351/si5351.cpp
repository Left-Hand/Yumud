...
static constexpr auto RFRAC_DENOM 					 = 1000000ULL;
static constexpr auto SI5351_XTAL_FREQ                 = 25000000;
static constexpr auto SI5351_PLL_FIXED                 = 80000000000ULL;
static constexpr auto SI5351_FREQ_MULT                 = 100ULL;
static constexpr auto SI5351_DEFAULT_CLK               = 1000000000ULL;
static constexpr auto SI5351_PLL_VCO_MIN               = 600000000;
static constexpr auto SI5351_PLL_VCO_MAX               = 900000000;
static constexpr auto SI5351_MULTISYNTH_MIN_FREQ       = 500000;
static constexpr auto SI5351_MULTISYNTH_DIVBY4_FREQ    = 150000000;
static constexpr auto SI5351_MULTISYNTH_MAX_FREQ       = 225000000;
static constexpr auto SI5351_MULTISYNTH_SHARE_MAX      = 100000000;
static constexpr auto SI5351_MULTISYNTH_SHARE_MIN      = 1024000;
static constexpr auto SI5351_MULTISYNTH67_MAX_FREQ     = SI5351_MULTISYNTH_DIVBY4_FREQ;
static constexpr auto SI5351_CLKOUT_MIN_FREQ           = 4000;
static constexpr auto SI5351_CLKOUT_MAX_FREQ           = SI5351_MULTISYNTH_MAX_FREQ;
static constexpr auto SI5351_MULTISYNTH67_A_MAX        = 254;
static constexpr auto SI5351_CLKOUT67_MS_MIN           = SI5351_PLL_VCO_MIN / SI5351_MULTISYNTH67_A_MAX;
static constexpr auto SI5351_CLKOUT67_MIN_FREQ         = SI5351_CLKOUT67_MS_MIN / 128;
static constexpr auto SI5351_CLKOUT67_MAX_FREQ         = SI5351_MULTISYNTH67_MAX_FREQ;
static constexpr auto SI5351_PLL_A_MIN                 = 15;
static constexpr auto SI5351_PLL_A_MAX                 = 90;
static constexpr auto SI5351_PLL_C_MAX                 = 1048575;
static constexpr auto SI5351_PLL_B_MAX                 = (SI5351_PLL_C_MAX-1);
static constexpr auto SI5351_MULTISYNTH_A_MIN          = 6;
static constexpr auto SI5351_MULTISYNTH_A_MAX          = 1800;
static constexpr auto SI5351_MULTISYNTH_C_MAX          = 1048575;
static constexpr auto SI5351_MULTISYNTH_B_MAX          = (SI5351_MULTISYNTH_C_MAX-1);
static constexpr auto SI5351_MULTISYNTH_P1_MAX         = ((1<<18)-1);
static constexpr auto SI5351_MULTISYNTH_P2_MAX         = ((1<<20)-1);
static constexpr auto SI5351_MULTISYNTH_P3_MAX         = ((1<<20)-1);
static constexpr auto SI5351_VCXO_PULL_MIN             = 30;
static constexpr auto SI5351_VCXO_PULL_MAX             = 240;
static constexpr auto SI5351_VCXO_MARGIN               = 103;
static constexpr auto SI5351_DEVICE_STATUS             = 0;
static constexpr auto SI5351_INTERRUPT_STATUS          = 1;
static constexpr auto SI5351_INTERRUPT_MASK            = 2;
static constexpr auto SI5351_STATUS_SYS_INIT           = (1<<7);
static constexpr auto SI5351_STATUS_LOL_B              = (1<<6);
static constexpr auto SI5351_STATUS_LOL_A              = (1<<5);
static constexpr auto SI5351_STATUS_LOS                = (1<<4);
static constexpr auto SI5351_OUTPUT_ENABLE_CTRL        = 3;
static constexpr auto SI5351_OEB_PIN_ENABLE_CTRL       = 9;
static constexpr auto SI5351_PLL_INPUT_SOURCE          = 15;
static constexpr auto SI5351_CLKIN_DIV_MASK            = (3<<6);
static constexpr auto SI5351_CLKIN_DIV_1               = (0<<6);
static constexpr auto SI5351_CLKIN_DIV_2               = (1<<6);
static constexpr auto SI5351_CLKIN_DIV_4               = (2<<6);
static constexpr auto SI5351_CLKIN_DIV_8               = (3<<6);
static constexpr auto SI5351_PLLB_SOURCE               = (1<<3);
static constexpr auto SI5351_PLLA_SOURCE               = (1<<2);
static constexpr auto SI5351_CLK0_CTRL                 = 16;
static constexpr auto SI5351_CLK1_CTRL                 = 17;
static constexpr auto SI5351_CLK2_CTRL                 = 18;
static constexpr auto SI5351_CLK3_CTRL                 = 19;
static constexpr auto SI5351_CLK4_CTRL                 = 20;
static constexpr auto SI5351_CLK5_CTRL                 = 21;
static constexpr auto SI5351_CLK6_CTRL                 = 22;
static constexpr auto SI5351_CLK7_CTRL                 = 23;
static constexpr auto SI5351_CLK_POWERDOWN             = (1<<7);
static constexpr auto SI5351_CLK_INTEGER_MODE          = (1<<6);
static constexpr auto SI5351_CLK_PLL_SELECT            = (1<<5);
static constexpr auto SI5351_CLK_INVERT                = (1<<4);
static constexpr auto SI5351_CLK_INPUT_MASK            = (3<<2);
static constexpr auto SI5351_CLK_INPUT_XTAL            = (0<<2);
static constexpr auto SI5351_CLK_INPUT_CLKIN           = (1<<2);
static constexpr auto SI5351_CLK_INPUT_MULTISYNTH_0_4  = (2<<2);
static constexpr auto SI5351_CLK_INPUT_MULTISYNTH_N    = (3<<2);
static constexpr auto SI5351_CLK_DRIVE_STRENGTH_MASK   = (3<<0);
static constexpr auto SI5351_CLK_DRIVE_STRENGTH_2MA    = (0<<0);
static constexpr auto SI5351_CLK_DRIVE_STRENGTH_4MA    = (1<<0);
static constexpr auto SI5351_CLK_DRIVE_STRENGTH_6MA    = (2<<0);
static constexpr auto SI5351_CLK_DRIVE_STRENGTH_8MA    = (3<<0);
static constexpr auto SI5351_CLK3_0_DISABLE_STATE      = 24;
static constexpr auto SI5351_CLK7_4_DISABLE_STATE      = 25;
static constexpr auto SI5351_CLK_DISABLE_STATE_MASK    = 3;
static constexpr auto SI5351_CLK_DISABLE_STATE_LOW     = 0;
static constexpr auto SI5351_CLK_DISABLE_STATE_HIGH    = 1;
static constexpr auto SI5351_CLK_DISABLE_STATE_FLOAT   = 2;
static constexpr auto SI5351_CLK_DISABLE_STATE_NEVER   = 3;
static constexpr auto SI5351_PARAMETERS_LENGTH         = 8;
static constexpr auto SI5351_PLLA_PARAMETERS           = 26;
static constexpr auto SI5351_PLLB_PARAMETERS           = 34;
static constexpr auto SI5351_CLK0_PARAMETERS           = 42;
static constexpr auto SI5351_CLK1_PARAMETERS           = 50;
static constexpr auto SI5351_CLK2_PARAMETERS           = 58;
static constexpr auto SI5351_CLK3_PARAMETERS           = 66;
static constexpr auto SI5351_CLK4_PARAMETERS           = 74;
static constexpr auto SI5351_CLK5_PARAMETERS           = 82;
static constexpr auto SI5351_CLK6_PARAMETERS           = 90;
static constexpr auto SI5351_CLK7_PARAMETERS           = 91;
static constexpr auto SI5351_CLK6_7_OUTPUT_DIVIDER     = 92;
static constexpr auto SI5351_OUTPUT_CLK_DIV_MASK       = (7 << 4);
static constexpr auto SI5351_OUTPUT_CLK6_DIV_MASK      = (7 << 0);
static constexpr auto SI5351_OUTPUT_CLK_DIV_SHIFT      = 4;
static constexpr auto SI5351_OUTPUT_CLK_DIV6_SHIFT     = 0;
static constexpr auto SI5351_OUTPUT_CLK_DIV_1          = 0;
static constexpr auto SI5351_OUTPUT_CLK_DIV_2          = 1;
static constexpr auto SI5351_OUTPUT_CLK_DIV_4          = 2;
static constexpr auto SI5351_OUTPUT_CLK_DIV_8          = 3;
static constexpr auto SI5351_OUTPUT_CLK_DIV_16         = 4;
static constexpr auto SI5351_OUTPUT_CLK_DIV_32         = 5;
static constexpr auto SI5351_OUTPUT_CLK_DIV_64         = 6;
static constexpr auto SI5351_OUTPUT_CLK_DIV_128        = 7;
static constexpr auto SI5351_OUTPUT_CLK_DIVBY4       	 = (3<<2);
static constexpr auto SI5351_SSC_PARAM0                = 149;
static constexpr auto SI5351_SSC_PARAM1                = 150;
static constexpr auto SI5351_SSC_PARAM2                = 151;
static constexpr auto SI5351_SSC_PARAM3                = 152;
static constexpr auto SI5351_SSC_PARAM4                = 153;
static constexpr auto SI5351_SSC_PARAM5                = 154;
static constexpr auto SI5351_SSC_PARAM6                = 155;
static constexpr auto SI5351_SSC_PARAM7                = 156;
static constexpr auto SI5351_SSC_PARAM8                = 157;
static constexpr auto SI5351_SSC_PARAM9                = 158;
static constexpr auto SI5351_SSC_PARAM10               = 159;
static constexpr auto SI5351_SSC_PARAM11               = 160;
static constexpr auto SI5351_SSC_PARAM12               = 161;
static constexpr auto SI5351_VXCO_PARAMETERS_LOW       = 162;
static constexpr auto SI5351_VXCO_PARAMETERS_MID       = 163;
static constexpr auto SI5351_VXCO_PARAMETERS_HIGH      = 164;
static constexpr auto SI5351_CLK0_PHASE_OFFSET         = 165;
static constexpr auto SI5351_CLK1_PHASE_OFFSET         = 166;
static constexpr auto SI5351_CLK2_PHASE_OFFSET         = 167;
static constexpr auto SI5351_CLK3_PHASE_OFFSET         = 168;
static constexpr auto SI5351_CLK4_PHASE_OFFSET         = 169;
static constexpr auto SI5351_CLK5_PHASE_OFFSET         = 170;
static constexpr auto SI5351_PLL_RESET                 = 177;
static constexpr auto SI5351_PLL_RESET_B               = (1<<7);
static constexpr auto SI5351_PLL_RESET_A               = (1<<5);
static constexpr auto SI5351_CRYSTAL_LOAD              = 183;
static constexpr auto SI5351_CRYSTAL_LOAD_MASK         = (3<<6);
static constexpr auto SI5351_CRYSTAL_LOAD_0PF          = (0<<6);
static constexpr auto SI5351_CRYSTAL_LOAD_6PF          = (1<<6);
static constexpr auto SI5351_CRYSTAL_LOAD_8PF          = (2<<6);
static constexpr auto SI5351_CRYSTAL_LOAD_10PF         = (3<<6);
static constexpr auto SI5351_FANOUT_ENABLE             = 187;
static constexpr auto SI5351_CLKIN_ENABLE              = (1<<7);
static constexpr auto SI5351_XTAL_ENABLE               = (1<<6);
static constexpr auto SI5351_MULTISYNTH_ENABLE         = (1<<4);
