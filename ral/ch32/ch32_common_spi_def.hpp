...
namespace ymd::ral::ch32::common_spi{
struct [[nodiscard]] R32_SPI_CTLR1{
    uint32_t CPHA:1;
    uint32_t CPOL:1;
    uint32_t MSTR:1;
    uint32_t BR:3;
...
//SPI 状态寄存器1
struct [[nodiscard]] R32_SPI_STATR{
    uint32_t RXNE:1;
    uint32_t TXE:1;
    uint32_t CHSIDE:1;
    uint32_t UDR:1;
...
struct [[nodiscard]] R32_SPI_CRCR{
    uint32_t CRCPOLY;
};

struct [[nodiscard]] R32_SPI_RCRCR{
    uint32_t RXCRC;
};

struct [[nodiscard]] R32_SPI_TCRCR{
    uint32_t TXCRC;
};

//SPI 时钟寄存器
struct [[nodiscard]] R32_SPI_I2S_CFGR{
    uint32_t CHLEN:1;
    uint32_t DATLEN:2;
    uint32_t CKPOL:1;
...
struct [[nodiscard]] R32_SPI_HSCR{
    uint32_t HSRXEN:1;
    uint32_t :31;
};

struct [[nodiscard]] SPI_Def{
