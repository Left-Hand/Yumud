...
static constexpr uint8_t FRAME_HEAD_CHAR             = 0xC5;        /* 帧头 */
static constexpr uint8_t FRAME_TAIL_CHAR             = 0x5C;        /* 帧尾 */
...
enum class [[nodiscard]] Command:uint8_t{
    ...
    GetPosition                = 0x2A,      /* 读取电机实时位置 */
    GetPositionError          = 0x2B,      /* 读取电机位置误差 */
    GetMotorStatus          = 0x2C,      /* 读取电机运行状态 */
    GetStallFlag          = 0x2D,      /* 读取堵转标志 */
    GetStallCurrent           = 0x2E,      /* 读取堵转电流 */
    ...
    SetMode                = 0x62,      /* 设置工作模式 */
    SetPositionPidParaments             = 0x63,      /* 设置位置环PID */
    SetPositionLoopTorque          = 0x64,      /* 设置位置环最大力矩限制 */
    SetStep                = 0x65,      /* 设置细分 */
    SetCurrent                  = 0x66,      /* 设置目标电流 */
    SetUartBaud           = 0x67,      /* 设置串口波特率 */
    SetCanBaud            = 0x68,      /* 设置CAN波特率 */
    SetModbus              = 0x69,      /* 设置MODBUS协议 */
    SetStallProtect            = 0x6A,      /* 设置堵转保护 */
    SetStallCurrent            = 0x6B,      /* 设置堵转电流 */
    ...
    /* 限位回零相关指令：(0x90~0x9F) */
    HommingSetLeftPos     = 0x90,      /* 设左限位原点位置 */
    HommingLimitHome       = 0x91,      /* 有无限位回零 */
    HommingTrig             = 0x92,      /* 触发回零 */
    HommingBreak            = 0x93,      /* 强制中断并退出回零操作 */
    HommingReadParams      = 0x94,      /* 读取回零参数 */
    HommingSetParams       = 0x95,      /* 修改原点回零超时时间 */
    HommingReadSta         = 0x96,      /* 读取回零状态 */
    HommingAotoZero        = 0x97,      /* 上电自动回零设置 */
    HommingSetRightPos    = 0x98,      /* 设右限位原点位置 */
    HommingSwitch           = 0x99,      /* 左右限位开关 */
    ...
    PositionMode                = 0xF2,      /* 绝对位置模式控制 */
    RelPositionMode            = 0xF3,      /* 相对位置模式控制 */
    PulsesMode             = 0xF4,      /* 脉冲模式 */
    PulseWidthPositionMode    = 0xF5,      /* 脉宽位置模式 */
    PulseWidthCurrentMode     = 0xF6,      /* 脉宽电流模式 */
    PulseWidthSpeedMode  = 0xF7,      /* 脉宽速度模式 */
    SetOrigin              = 0xF8,      /* 将当前的位置清零 */
    ClearStallPro          = 0xF9,      /* 解除堵转状态 */
    Enable            = 0xFA,      /* 电机使能控制 */
