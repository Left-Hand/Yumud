...
[[maybe_unused]] static void test_ser0x01(){
...

    {
        ...
        static_assert(serializer.bytes[2]  == 0x13);
        static_assert(serializer.bytes[3]  == 0x8b);

        static_assert(serializer.bytes[4]  == 0x00);
        static_assert(serializer.bytes[5]  == 0x01);
        static_assert(serializer.bytes[6]  == 0x45);
        static_assert(serializer.bytes[7]  == 0x64);
    }
...

    {
        ...
        static_assert(serializer.bytes[1]  == 0x04);
        static_assert(serializer.bytes[2]  == 0x13);
        static_assert(serializer.bytes[3]  == 0x94);

        static_assert(serializer.bytes[4]  == 0x00);
        static_assert(serializer.bytes[5]  == 0x01);
        static_assert(serializer.bytes[6]  == 0x74);
        static_assert(serializer.bytes[7]  == 0xa2);
    }

    {
        ...
        static_assert(serializer.bytes[1]  == 0x04);
        static_assert(serializer.bytes[2]  == 0x13);
        static_assert(serializer.bytes[3]  == 0x95);

        static_assert(serializer.bytes[4]  == 0x00);
        static_assert(serializer.bytes[5]  == 0x01);
        static_assert(serializer.bytes[6]  == 0x25);
        static_assert(serializer.bytes[7]  == 0x62);
    }

    {
        ...
        static_assert(serializer.bytes[1]  == 0x04);
        static_assert(serializer.bytes[2]  == 0x13);
        static_assert(serializer.bytes[3]  == 0x92);

        static_assert(serializer.bytes[4]  == 0x00);
        static_assert(serializer.bytes[5]  == 0x02);
        static_assert(serializer.bytes[6]  == 0xd4);
        static_assert(serializer.bytes[7]  == 0xa2);
    }
