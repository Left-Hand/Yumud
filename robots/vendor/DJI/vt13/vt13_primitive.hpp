...
struct [[nodiscard]] KeySpecifiers final {
    ...
    VT13_KEY_SPECIFIER_BIT(q,  6)
    VT13_KEY_SPECIFIER_BIT(e,  7)
    VT13_KEY_SPECIFIER_BIT(r,  8)
    VT13_KEY_SPECIFIER_BIT(f,  9)
    VT13_KEY_SPECIFIER_BIT(g,  10)
    VT13_KEY_SPECIFIER_BIT(z,  11)
    VT13_KEY_SPECIFIER_BIT(x,  12)
    VT13_KEY_SPECIFIER_BIT(c,  13)
    VT13_KEY_SPECIFIER_BIT(v,  14)
    VT13_KEY_SPECIFIER_BIT(b,  15)
};
