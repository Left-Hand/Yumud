...
static_assert(PdoFunctionCode::from_bits(0).is_none());
static_assert(PdoFunctionCode::from_bits(4).is_some());

[[maybe_unused]] static void test1(){
    static constexpr auto layout1 = SdoExpeditedLayout::from_exception(
