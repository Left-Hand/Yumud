...
void GrabModule::rapid(const Vector3<q16> & pos){
...
void GrabModule::move(const Vector3<q16> & pos){
    auto & self = *this;
    self << new MoveAction(self, pos);
}

void GrabModule::move_xy(const Vector2<q16> & pos){
    auto & self = *this;
...
void GrabModule::test(){
    ...
    self << new TestAction{self};
    // self << MoveAction(self, Vector3<q16>(0, 0, 0), Vector3<q16>(1,1,1));
    // self << new MoveAction(self, Vector3<q16>(0, 0.2_r, 0.1_r), Vector3<q16>(0.1_r,0.2_r,0.1_r));
...
// Vector2<q16> GrabModule::calculateTrayPos(TrayIndex index) const{
//     // return {config_.tray_xy[size_t(index)].x, 0.144_r};
//     return {config_.tray_xy[size_t(index)]};
//     // switch(index){
//     //     case TrayIndex::Left :
//     //         return (Vector2<q16>{-0.1_r, 0.2_r});  
//     //     case TrayIndex::Center :
//     //         return (Vector2<q16>{0, 0.2_r});  
//     //     case TrayIndex::Right :
//     //         return (Vector2<q16>{0.1_r, 0.2_r});  
//     // }
// }

// Vector2<q16> GrabModule::calculateCatchPos(TrayIndex index) const{
//     return {config_.catch_xy[size_t(index)]};
//     // switch(index){
//     //     default:
//     //     case TrayIndex::Left :
//     //         return (Vector2<q16>{-0.1_r, 0.24_r});  
//     //     case TrayIndex::Center :
//     //         return (Vector2<q16>{0, 0.24_r});  
//     //     case TrayIndex::Right :
//     //         return (Vector2<q16>{0.1_r, 0.24_r});  
//     // }
// }