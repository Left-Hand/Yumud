...
#define MSG(cmd, payload) CanClassicFrame::from_tuple(\
...
real_t RemoteFOCMotor::read_acc() const{POST(Command::read_acc); return readAcc();}
...
#if 0
void RemoteFOCMotor::parseCanmsg(const CanClassicFrame &msg){
