...
public:
    ...
    constexpr void reconf(const Config & cfg){
        ...
        const auto [s_sum, c_sum] = math::sincospu(T(cfg.fh+cfg.fl) / (cfg.fs * 2));
        const auto [s_delta, c_delta] = math::sincospu(T(cfg.fh-cfg.fl) / (cfg.fs * 2));
