...
FFT::FFT(double *vReal, double *vImag, uint16_t samples,
...
void FFT::MajorPeak(double *f, double *v) {
  double maxY = 0;
  uint16_t IndexOfMaxY = 0;
  // If sampling_frequency = 2 * max_frequency in signal,
  // value would be stored at position samples/2
...
void FFT::Parabola(double x1, double y1, double x2, double y2, double x3,
