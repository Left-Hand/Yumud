...
#define TM_DBGT_START()    auto _start=TM_GET_US();
#define TM_DBGT()         {auto _finish=TM_GET_US();\
                            auto _time = (_finish-_start);\
                            DEBUG_PRINT("===use ");DEBUG_PRINT(_time);DEBUG_PRINT("us\n");\
                            _start=TM_GET_US();}
...
public:
    ...
    using Result = std::pair<int, real_t>;
