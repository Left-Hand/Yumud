...
void can_ring_main(){
    ...
    static constexpr auto UNREACHABLE_MSGS = std::to_array({
        hal::CanMsg::from_list(hal::CanStdId(0x100), {0, 1, 3}),
        hal::CanMsg::from_bytes(hal::CanStdId(0x300), std::bit_cast<std::array<uint8_t, 4>>(0x12345678)),
        hal::CanMsg::from_bytes(hal::CanExtId(0x400), std::bit_cast<std::array<uint8_t, 4>>(0x12345678))
    });

    static constexpr auto REACHABLE_MSGS = std::to_array({
        hal::CanMsg::from_list(hal::CanStdId(0x200), {0, 1, 2}),
        hal::CanMsg::from_bytes(hal::CanStdId(0x200), std::bit_cast<std::array<uint8_t, 4>>(0x12345678)),
    });
