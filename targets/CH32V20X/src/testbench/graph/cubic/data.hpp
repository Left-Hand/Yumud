...
{
	vec3_t{-1.0f, -1.0f, -1.0f}, // 0
	vec3_t{ 1.0f,  1.0f, -1.0f}, // 1
	vec3_t{ 1.0f, -1.0f, -1.0f}, // 2
	vec3_t{-1.0f,  1.0f, -1.0f}, // 3
	vec3_t{-1.0f, -1.0f,  1.0f}, // 4
	vec3_t{ 1.0f, -1.0f,  1.0f}, // 5
	vec3_t{ 1.0f,  1.0f,  1.0f}, // 6
	vec3_t{-1.0f,  1.0f,  1.0f}, // 7
};
