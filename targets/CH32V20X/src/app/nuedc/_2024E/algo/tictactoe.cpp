...
static constexpr void test(){
    ...
    static_assert(fn(Role::O, ChessBoard{{
        ...
        std::to_array({ChessCell::N(), ChessCell::N(), ChessCell::N()}),
        std::to_array({ChessCell::N(), ChessCell::N(), ChessCell::N()}),
    }}) == math::Vec2u{1,1}, "Center should be first choice");
    ...
    }}) == math::Vec2u{2,0}, "Should complete winning row");
    ...
    static_assert(fn(Role::O, ChessBoard{{
        ...
        std::to_array({ChessCell::N(), ChessCell::N(), ChessCell::N()}),
    }}) == math::Vec2u{0,2}, "Should block opponent's column win");
    ...
    static_assert(fn(Role::X, ChessBoard{{
        ...
        std::to_array({ChessCell::N(), ChessCell::O(), ChessCell::N()}),
        std::to_array({ChessCell::N(), ChessCell::N(), ChessCell::N()}),
    }}) == math::Vec2u{0,0}, "Corner should be second choice");
    ...
    }}) == math::Vec2u{1,0}, "Edge should be final fallback");
    ...
    }}) == math::Vec2u{0,2}, "Should prioritize blocking over offense");
}
