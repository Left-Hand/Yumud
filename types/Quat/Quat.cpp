...
// 	float cos_a1 = cosf(half_a1);
// 	float sin_a1 = sinf(half_a1);
// 	float cos_a2 = cosf(half_a2);
// 	float sin_a2 = sinf(half_a2);
// 	float cos_a3 = cosf(half_a3);
// 	float sin_a3 = sinf(half_a3);
...
// 	return is_equal_approx_f(x, p_quat.x) && is_equal_approx_f(y, p_quat.y) && is_equal_approx_f(z, p_quat.z) && is_equal_approx_f(w, p_quat.w);
// }
...
// 	return is_equal_approx_f(length_squared(), 1.0f); //use less epsilon
// }
...
// Quat Quat::slerp(const Quat &p_to, const float &p_weight) const {
// 	Quat to1;
...
// Quat Quat::slerpni(const Quat &p_to, const float &p_weight) const {
// 	const Quat &from = *this;

// 	float dot = from.dot(p_to);
...
// Quat Quat::cubic_slerp(const Quat &p_b, const Quat &p_pre_a, const Quat &p_post_b, const float &p_weight) const {

// 	float t2 = (1.0 - p_weight) * p_weight * 2;
...
// 		set(0, 0, 0, 0);
// 	} else {
// 		float sin_angle = sinf(angle * 0.5);
// 		float cos_angle = cosf(angle * 0.5);
// 		float s = sin_angle / d;
