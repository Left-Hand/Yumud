...
// 		return Color(
// 				r < 0.0031308 ? 12.92 * r : (1.0 + 0.055) * std::pow(r, real_t(1.0f / 2.4f)) - 0.055,
// 				g < 0.0031308 ? 12.92 * g : (1.0 + 0.055) * std::pow(g, real_t(1.0f / 2.4f)) - 0.055,
// 				b < 0.0031308 ? 12.92 * b : (1.0 + 0.055) * std::pow(b, real_t(1.0f / 2.4f)) - 0.055, a);
// 	}
