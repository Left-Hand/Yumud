...
public:
    ...
    [[nodiscard]] bool is_low() const noexcept {return read() == BoolLevel::LOW;}
    [[nodiscard]] bool is_high() const noexcept {return read() == BoolLevel::HIGH;}
    ...
    operator BoolLevel() const noexcept {return(this->read());}
};
