...
#define     USB_OTG_CR_SESS           0x20               // usb otg control,�Ự��ƽʹ��
#define     USB_OTG_CR_VBUS           0x10               // usb otg control,VBUS��ƽʹ��
#define     USB_OTG_CR_OTG_EN         0x08               // usb otg control,OTG����ʹ��
#define     USB_OTG_CR_IDPU           0x04               // usb otg control,ID��������
#define     USB_OTG_CR_CHARGEVBUS     0x02               // usb otg control,VBUS���
#define     USB_OTG_CR_DISCHARGEVBUS  0x01               // usb otg control,VBUS�ŵ�

#define  USB_OTG_SR          (USBOTG_FS->OTG_CR)  // usb otg status
#define     USB_OTG_SR_VBUS_VLD       0x01               // usb otg status,A�豸VBUS�����ƽ��Ч
#define     USB_OTG_SR_SESS_VLD       0x02               // usb otg status,�Ự��Ч��ƽ��Ч��־
#define     USB_OTG_SR_SESS_END       0x04               // usb otg status,�Ự������ƽ��Ч��־
#define     USB_OTG_SR_ID_DIG         0x08               // usb otg status,ID��ƽ
#endif
...
extern volatile UINT16 USBHD_Endp1_Up_Flag;                                     /* USB2.0�����豸�˵�1�����ϴ�״̬: 0:����; 1:�����ϴ�; */
extern volatile UINT8  USBHD_Endp1_Down_Flag;                                   /* USB2.0�����豸�˵�1�´��ɹ���־ */
extern volatile UINT8  USBHD_Endp1_Down_Len;                                    /* USB2.0�����豸�˵�1�´����� */
extern volatile BOOL   USBHD_Endp1_T_Tog;                                       /* USB2.0�����豸�˵�1����togλ��ת */
extern volatile BOOL   USBHD_Endp1_R_Tog;

extern volatile UINT16 USBHD_Endp2_Up_Flag;                                     /* USB2.0�����豸�˵�2�����ϴ�״̬: 0:����; 1:�����ϴ�; */
extern volatile UINT16 USBHD_Endp2_Up_LoadPtr;                                  /* USB2.0�����豸�˵�2�����ϴ�װ��ƫ�� */
extern volatile UINT8  USBHD_Endp2_Down_Flag;                                   /* USB2.0�����豸�˵�2�´��ɹ���־ */
...
extern UINT8 EP2_DatabufHD[64+64];  //ep2_out(64)+ep2_in(64) ��������˵�
